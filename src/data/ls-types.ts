...
export interface LSNotification {
  ...
  reason: string; // Main reason/description (ILMOITUKSEN PERUSTE)
  concerns?: string; // HUOLEN AIHEET - huolta aiheuttavat seikat
  actions?: string; // TOIMENPITEET - tehdyt tai suunnitellut toimenpiteet
  ...
  reporterSummary?: string; // Short reporter role from LLM (e.g., "Koulupsykologi")
  reasonFromLLM?: string; // Longer description from LLM (200-500 chars)
  // Audit fields
...
export interface CaseNote {
  ...
  filename?: string;
  keywords?: string[]; // e.g., ['tapaaminen', 'kotikäynti']
  summary: string; // Manual short summary written by user
  fullText: string;
  // Audit fields
  updatedAt?: string; // ISO timestamp
  updatedBy?: string; // User email
