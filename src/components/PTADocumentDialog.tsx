...
import { FileText, Calendar, Users, CheckCircle, X } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            {document.sections && Object.keys(document.sections).length > 0 ? (
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="prose prose-sm max-w-none">
                    <ReactMarkdown>{document.fullText}</ReactMarkdown>
                  </div>
                </CardContent>
              </Card>
            )}
              ...
              <Card className="bg-purple-50 border-purple-200">
                <CardContent className="pt-6">
                  ...
                  <div className="prose prose-sm max-w-none text-purple-800">
                    <ReactMarkdown>{document.aiGuidance}</ReactMarkdown>
                  </div>
                </CardContent>
              </Card>
            </>
