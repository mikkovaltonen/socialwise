...
|---------|--------|-----------|
| **searchPurchases** | Material | ProductNumber, Date, Vendor, Quantity, UnitPrice, DeliveryTime |
| **searchMaterialAttributes** | Material | Material, Plant, MinStock, KeyCode |
...
|    |
|    +-- Yes -> add slittable qty to NET (per due date) -> go to C
|    +-- No  -> go to C
|
